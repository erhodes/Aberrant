...
ActiveRecord::Schema.define(version: 20141108202403) do
  ...
  create_table "characters_organizations", force: true do |t|
  ...
  add_index "characters_organizations", ["character_id", "organization_id"], name: "by_character_organization", unique: true
  add_index "characters_organizations", ["character_id"], name: "index_characters_organizations_on_character_id"
  add_index "characters_organizations", ["organization_id"], name: "index_characters_organizations_on_organization_id"
